...
const MyLoader: FC<LoaderProps> = ({ isMobileMode }) => (
  <>
    {isMobileMode ? (
      ...
      >
        <rect x="15" y="72" rx="3" ry="3" width="88" height="8" />
        <rect x="11" y="-2" rx="15" ry="15" width="131" height="62" />
        <rect x="16" y="90" rx="3" ry="3" width="125" height="8" />
        <rect x="16" y="108" rx="3" ry="3" width="125" height="8" />
      </ContentLoader>
    ) : (
      <ContentLoader
        speed={2}
